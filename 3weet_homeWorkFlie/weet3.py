...
def post():
    ...
    quantity_receive = request.form['quantity_giv']  # 주문할 수량을 받는 부분
    address_receive = request.form['address_giv']  # 배송할 address 받는 부분
    phone_receive = request.form['phone_giv']  # 고객 phone 받는 부분
